...
type TransactionRepository interface {
	...
	FindOrders(uId uint) ([]domain.Reservation, error)
	FindOrderById(uId uint, id uint) (dto.LessorOrderDetails, error)
}
...
func (t transactionStorage) FindOrders(uId uint) ([]domain.Reservation, error) {
	//TODO implement me
	panic("implement me")
}

func (t transactionStorage) FindOrderById(uId uint, id uint) (dto.LessorOrderDetails, error) {
	//TODO implement me
	panic("implement me")
}
